...
var write_question_screen = function()
{
    ...
    {
        modal = "<div class='modal-header'><div class='text-center quiz-question'><h3 class='modal-title'>" + current_question.question + "</h3><div class='question-img'><img class='img-fluid' src=" + current_question.image_url + "></div></div></div>";
    }else
    {
        modal = "<div class='modal-header'><div class='text-center quiz-question'><h3 class='modal-title'>" + current_question.question + "</h3><div class='question-img'></div></div></div>";
    }
...
var write_final_screen = function()
{
    ...
    modal += "<div class='modal-body'><div class='final-score quiz-bold-white-content'>" + score + "/" + num_of_questions + "</div></br><div class='final-message quiz-bold-white-content'>" + get_final_message() + "</div></br><button class='element-animation1 btn btn-lg btn-light text-info' onclick='restart_quiz()'>Jogar Novamente</button></div>";
